...
ALTER TABLE TBL_TYPE_BUSINESS_PARTNER
	ADD CONSTRAINT PK_TYPE_BUSINESS_PARTNER PRIMARY KEY (IDCOMPANY,TYPBUSPAR);

INSERT INTO TBL_TYPE_BUSINESS_PARTNER (IDCOMPANY,TYPBUSPAR, ABREVI, DESCRI, CODEXT, OBSERV, COMMEN, DEFAUL)
VALUES
...
ALTER TABLE TBL_TYPE_PAYMENT_CONDITION
	ADD CONSTRAINT PK_TYPE_PAYMENT_CONDITION PRIMARY KEY (IDCOMPANY,TYPPAYCON);

INSERT INTO TBL_TYPE_PAYMENT_CONDITION (IDCOMPANY,TYPPAYCON, ABREVI, DESCRI)
VALUES 
...
INNER JOIN TBL_TYPE_PAYMENT_CONDITION TCP ON TCP.IDCOMPANY = ICP.IDCOMPANY AND TCP.TYPPAYCON = ICP.TYPPAYCON;
