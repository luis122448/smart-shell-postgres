...
ALTER TABLE TBL_DOCUMENT_HEADER
    ADD CONSTRAINT PK_DOCUMENT_HEADER PRIMARY KEY (NUMINT);
...
ALTER TABLE TBL_DOCUMENT_DETAIL
    ADD CONSTRAINT PK_DOCUMENT_DETAIL PRIMARY KEY (NUMINT,NUMITE);
	
ALTER TABLE TBL_DOCUMENT_DETAIL
    ADD CONSTRAINT FK_DOCUMENT_HEADER FOREIGN KEY (NUMINT)
        REFERENCES TBL_DOCUMENT_HEADER (NUMINT);
