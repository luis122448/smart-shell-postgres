...
ALTER TABLE TBL_TYPE_COMMERCIAL_DOCUMENT
	ADD CONSTRAINT PK_TYPE_COMMERCIAL_DOCUMENT PRIMARY KEY (IDC0MPANY,TYPCOMDOC);
	
INSERT INTO TBL_TYPE_COMMERCIAL_DOCUMENT (IDC0MPANY,TYPCOMDOC, ABREVI, DESCRI, CODEXT, OBSERV, COMMEN)
VALUES
...
ALTER TABLE TBL_FORMAT_COMMERCIAL_DOCUMENT
	ADD CONSTRAINT PK_FORMAT_COMMERCIAL_DOCUMENT PRIMARY KEY (IDC0MPANY,TYPCOMDOC,TYPFORMAT);

INSERT INTO TBL_FORMAT_COMMERCIAL_DOCUMENT (IDC0MPANY,TYPCOMDOC,TYPFORMAT,ABREVI,DESCRI,FORMAT,URL,IMAGE,PDF,OBSERV,COMMEN,DEFAUL)
VALUES
...
ALTER TABLE TBL_SERIE_COMMERCIAL_DOCUMENT
	ADD CONSTRAINT PK_SERIE_COMMERCIAL_DOCUMENT PRIMARY KEY (IDC0MPANY,TYPCOMDOC, SERIE); 

INSERT INTO TBL_SERIE_COMMERCIAL_DOCUMENT (IDC0MPANY,TYPCOMDOC, SERIE, CODBRANCH, ABREVI, DESCRI, CODEXT, DOCELECTR, TYPCORREL, NROCORREL, DEFAUL, TYPFORMAT)
VALUES 
...
ALTER TABLE TBL_SITUATION_COMMERCIAL_DOCUMENT
	ADD CONSTRAINT PK_SITUATION_COMMERCIAL_DOCUMENT PRIMARY KEY (IDC0MPANY,TYPCOMDOC,SITCOMDOC);
	
-- DOCUMENT SITUATION
INSERT INTO TBL_SITUATION_COMMERCIAL_DOCUMENT (IDC0MPANY,TYPCOMDOC, SITCOMDOC, ABREVI, DESCRI)
VALUES
(1,1, 1, 'Issued', 'Issued'),
...
ALTER TABLE TBL_EXCHANGE_RATE
	ADD CONSTRAINT PK_EXCHANGE_RATE PRIMARY KEY (IDC0MPANY,REGISTDATE, ORIGEN, DESTIN);

INSERT INTO TBL_EXCHANGE_RATE (IDC0MPANY,REGISTDATE, ORIGEN, DESTIN, EVENTA, ECOMPRA)
VALUES 
...
ALTER TABLE TBL_COMMERCIAL_FACTOR
	ADD CONSTRAINT PK_COMMERCIAL_FACTOR PRIMARY KEY (IDC0MPANY,CODCOMFAC);

INSERT INTO TBL_COMMERCIAL_FACTOR (IDC0MPANY,CODCOMFAC, ABREVI, DESCRI, CODEXT, VCARACTER, VTEXTO, VENTERO,
...
ALTER TABLE TBL_REASON_COMMERCIAL_DOCUMENT
	ADD CONSTRAINT PK_MOTIVO_COMERCIAL PRIMARY KEY (IDC0MPANY,TYPCOMDOC,INGSALCOM,REACOMDOC);

INSERT INTO TBL_REASON_COMMERCIAL_DOCUMENT (IDC0MPANY,TYPCOMDOC, INGSALCOM, REACOMDOC, ABREVI, DESCRI, CODEXT, OBSERV,DEFAUL)
VALUES
...
ALTER TABLE TBL_SELLER
	ADD CONSTRAINT PK_SELLER PRIMARY KEY (IDC0MPANY,CODSEL);
