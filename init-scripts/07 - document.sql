...
ALTER TABLE TBL_FORMAT_COMMERCIAL_DOCUMENT
	ADD CONSTRAINT PK_FORMAT_COMMERCIAL_DOCUMENT PRIMARY KEY (TYPCOMDOC,NUMINT);

INSERT INTO TBL_FORMAT_COMMERCIAL_DOCUMENT (TYPCOMDOC,NUMINT,ABREVI,DESCRI,FORMAT,OBSERV,COMMEN)
VALUES
(1,1,'INV A4-H','Invoice Format (A4 - Horizontal)','invoce-a4-horizontal.jrxml','',''),
(1,2,'INV A4-V','Invoice Format (A4 - Vertical)','invoce-a4-vertical.jrxml','',''),
(2,1,'INV A4-H','Receipt Format (A4 - Horizontal)','receipt-a4-horizontal.jrxml','',''),
(2,2,'INV A4-V','Receipt Format (A4 - Vertical)','receipt-a4-vertical.jrxml','','');
...
VALUES 
	(1, 'F001', 'FAC-01', 'Electronic Invoice', 'S', 'A', 0, 'Y', 1),
	(1, 'F002', 'FAC-02', 'Manual Invoice', 'S', 'M', 0, 'N', 1),
	(2, 'B001', 'BOL-01', 'Electronic REceipt', 'S', 'A', 0, 'Y', 1),
	(2, 'B002', 'BOL-02', 'Manual Receipt', 'S', 'M', 0, 'N', 1);
